...
#ifndef NDN_CONSUMER_ZIPF_PREFIX_MANDELBROT_H_
#define NDN_CONSUMER_ZIPF_PREFIX_MANDELBROT_H_
 ...
 */
class ConsumerZipfPrefixMandelbrot: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfPrefixMandelbrot ();
  virtual ~ConsumerZipfPrefixMandelbrot ();
...
#endif /* NDN_CONSUMER_ZIPF_PREFIX_MANDELBROT_H_ */
